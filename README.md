...
* **Central Game Hub:** A single `index.html` page to list all available games.
* **Pure Web Tech:** Games are implemented using only **HTML5, CSS3, and JavaScript**.
* **Responsive Design:** Optimized for play across different screen sizes (desktop, tablet, and mobile).
* **Modular Code:** Game logic is separated into dedicated files (`games.js`, `script.js`) for easy expansion and maintenance.
...
3.  Commit your changes (`git commit -m 'Feat: Add Amazing Game to the vault'`).
