const games = [
  ...
  },
  {
    ...
    longDesc: "This is a physics-based 3D visualization of the planet Saturn. The web app is designed to be controlled using hand tracking and recognition technology (requiring a camera and a compatible browser). Users can interact with the model by performing gestures such as rotating the planet by moving their hand, scattering the rings with an open hand, or assembling them with a pinch gesture to experience a playful, hands-on exploration of the astronomical body. Click <a href='https://github.com/Deepayan-Thakur' target='_blank' style='color: #0066cc; text-decoration: none; font-weight: normal;'>here</a> to see more works by Deepayan!",
